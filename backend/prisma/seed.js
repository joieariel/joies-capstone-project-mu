...
async function main() {
  ...
  const centers = [
    {
      ...
      description: 'A modern community center offering free internet access, computer training, and digital literacy programs.',
      latitude: 37.7749,
      longitude: -122.4194,
    },
    {
      ...
      image_url: 'https://images.unsplash.com/photo-1524178232363-1fb2b075b655?w=500',
      description: 'Community-focused center providing job training, computer classes, and study spaces.',
      latitude: 37.8044,
      longitude: -122.2712,
    },
    {
      ...
      image_url: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=500',
      description: 'Tech-focused community space with high-speed internet, 3D printing, and coding workshops.',
      latitude: 37.3382,
      longitude: -121.8863,
    },
    {
      ...
      image_url: 'https://images.unsplash.com/photo-1517048676732-d65bc937f952?w=500',
      description: 'Friendly neighborhood center offering free WiFi, printing services, and community events.',
      latitude: 37.8715,
      longitude: -122.2730,
    },
    {
      ...
      description: 'Innovation-focused space with maker tools, business mentoring, and entrepreneurship programs.',
      latitude: 37.4419,
      longitude: -122.1430,
    },
  ];
  ...
  for (const centerData of centers) {
    ...
    console.log(`Created community center: ${center.name}`);
  }
